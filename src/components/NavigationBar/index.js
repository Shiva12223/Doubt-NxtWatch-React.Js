  ...
  renderTabItems = () => (
    <NxtWatchContext.Consumer>
      {value => {
        ...
        const bgColor = isDarkTheme ? '#313131' : '#f9f9f9'
        const textColor = isDarkTheme ? '#f9f9f9' : '#231f20'
        const activeTabBbColor = isDarkTheme ? '#475569' : '#cbd5e1'
            ...
            <NavigationLgContainer bgColor={bgColor}>
              <NavOptions>
                <NavLink to="/">
                  <NavLinkContainer
                    key="home"
                    bgColor={activeTab === 'Home' ? activeTabBbColor : 'none'}
                ...
                <NavLink to="/trending">
                  <NavLinkContainer
                    key="trending"
                    bgColor={
                      activeTab === 'Trending' ? activeTabBbColor : 'none'
                    }
                ...
                <NavLink to="/gaming">
                  <NavLinkContainer
                    key="gaming"
                    bgColor={activeTab === 'Gaming' ? activeTabBbColor : 'none'}
                ...
                <NavLink to="/saved-videos">
                  <NavLinkContainer
                    key="saved"
                    bgColor={activeTab === 'Saved' ? activeTabBbColor : 'none'}
